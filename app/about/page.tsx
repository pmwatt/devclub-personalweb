...
export default function Page() {
  return (
    <>
        <Image className='rounded-full' src='https://bit.ly/dan-abramov' alt='Dan Abramov' />
      <h1 className='text-5xl p-5'>About Me</h1>
      <h2 className='text-3xl pt-12 pb-2'>"I was born at a very young age."</h2>
